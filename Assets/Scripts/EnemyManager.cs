...
public class EnemyManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject[] m_EnemyPrefabs; // Массив префабов врагов
    ...
    void SpawnEnemies()
    {
        ...
        if (m_CurrentSpawned < m_EnemyCount)
        {
            ...
            GameObject enemyPrefab = m_EnemyPrefabs[Random.Range(0, m_EnemyPrefabs.Length)];

            // Спауним врага
            LeanPool.Spawn(enemyPrefab, m_Spawne[randomPoint].position, Quaternion.identity);
